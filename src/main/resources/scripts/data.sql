...
INSERT INTO tb_estado(id_estado, estado, uf)
...
VALUES(1, 'Victória Andrade', 'victoria.andrade@bitscamp.com.br', 72451478, 'Rua 01', 61986352220, '', 1, 'Brasília', 4),
      ...
      (2, 'Everton Rodrigues', 'h3v3rton@gmail.com', 72451414, 'Rua 03', 61986352214, '', 1, 'Brasília', 3),
      (1, 'Telmo Silva', 'telmosilvah4@outlook.com', 72451419, 'Rua 04', 61986352217, '', 1, 'São Paulo', 2),
      ...
      (1, 'Helena Maria', 'h.elena@hotmail.com', 72451111, 'Rua 07', 61986352247, '', 1, 'Brasília', 4),
      (2, 'Maria Eduarda', 'duda87@gmail.com', 72451225, 'Rua 08', 61986352365, '', 1, 'Santos', 1);

INSERT INTO tb_loja
(cnpj_loja, nome_loja, telefone_loja, email_loja, municipio_loja, id_estado, cep_loja, endereco_loja)
VALUES(78965412365411, 'Loja 01', 61986325487, 'comercial@loja1.com.br', 'Rio de Janeiro', 2, 72365531, 'Avenida 01'),
      (78965412365422, 'Loja 02', 61986325488, 'comercial@loja2.com.br', 'Brasília', 4, 72365544, 'Avenida 02'),
      (78965412365433, 'Loja 03', 61986325489, 'comercial@loja3.com.br', 'Goiania', 3, 72365546, 'Avenida 03'),
      (78965412365444, 'Loja 04', 61986325490, 'comercial@loja4.com.br', 'Belo Horizonte', 3, 72365521, 'Avenida 04'),
      (78965412365455, 'Loja 05', 61986325491, 'comercial@loja5.com.br', 'São Paulo', 1, 72365511, 'Avenida 05');