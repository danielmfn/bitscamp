DROP TABLE  public.tb_perfil_cliente CASCADE;

DROP TABLE public.tb_categoria_usuario CASCADE;

DROP TABLE public.tb_estado CASCADE;

DROP TABLE public.tb_loja CASCADE;

DROP TABLE public.tb_indicacao_produto CASCADE;

DROP TABLE public.tb_log_comunicacao CASCADE;

DROP TABLE public.tb_feedback CASCADE;

DROP TABLE public.tb_usuario CASCADE;
